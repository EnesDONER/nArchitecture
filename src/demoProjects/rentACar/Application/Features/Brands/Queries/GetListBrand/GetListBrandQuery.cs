...
namespace Application.Features.Brands.Queries.GetListBrand
{
    public class GetListBrandQuery:IRequest<BrandListModel>
    {
        ...
        public class GetListBrandQueryHandler : IRequestHandler<GetListBrandQuery, BrandListModel>
        {
            ...
            public GetListBrandQueryHandler(IBrandRespository brandRespository,IMapper mapper)
            {
                _mapper = mapper;
            ...
            {
                IPaginate<Brand> brands = await _brandRespository.GetListAsync(index:request.PageRequest.Page,size:request.PageRequest.PageSize);
